...
update.on('exit', function (code,signal) {
	...
	], {stdio: "inherit", cwd: "/Users/mliedtka/i360walk-aus-ios/i360 Canvass/"});
	...
	clean.on('exit', function (code,signal) {
		...
		], {stdio: "inherit", cwd: "/Users/mliedtka/i360walk-aus-ios/i360 Canvass/"} ); //the 'inherit' preserves the colors from build process
